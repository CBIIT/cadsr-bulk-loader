...
public class SpringBeansUtil {
	...
	private void saveProperties(Properties props) {
		try {
			...
			String classFileDir = cl.getResource(".").getPath();
			
			File storeFile = null; 
			if (storePropsFileURL == null) {
				storeFile = new File(classFileDir+File.separatorChar+STORE_PROPS_FILE);
			}
			else {
				storeFile = new File(storePropsFileURL.getPath());
			}
