...
public class NewDELongNameAsAltNameTestCase extends gov.nih.nci.ncicb.cadsr.bulkloader.util.MainTestCase {

	private static String[] XML_IP_FILES = {"/gov/nih/nci/ncicb/cadsr/8_27_1_2.xml"};
	...
	public NewDELongNameAsAltNameTestCase() {
		super("NewDELongNameAsAltNameTestCase", NewDELongNameAsAltNameTestCase.class, dataURL);
	}
