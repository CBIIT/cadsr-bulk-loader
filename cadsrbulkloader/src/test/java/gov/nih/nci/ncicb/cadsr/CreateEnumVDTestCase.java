...
public class CreateEnumVDTestCase extends gov.nih.nci.ncicb.cadsr.bulkloader.util.MainTestCase {

	private static String[] XML_IP_FILES = {"/gov/nih/nci/ncicb/cadsr/8_19_1_oneQualifer_2.xml"};
	private static String dataURL = "/gov/nih/nci/ncicb/cadsr/8_19_1_oneQualifer_2.xls";
	...
	public CreateEnumVDTestCase() {
		super("CreateEnumVDTestCase", CreateEnumVDTestCase.class, dataURL);
	}
	
	public void testGF21730() {
