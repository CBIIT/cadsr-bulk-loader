...
public class EVSConceptsTestCase extends gov.nih.nci.ncicb.cadsr.bulkloader.util.MainTestCase {
	...
	public EVSConceptsTestCase() {
		super("ConceptLongNameNullTestCase", EVSConceptsTestCase.class, dataURL);
	}
